...
public final class CosmosNativeBridge {
    ...
    public static native long nativeClientCreateWithKey(long callContext, String endpoint, String key)
    ...
    public static native long nativeDatabaseClient(long callContext, long client, String databaseId)
        throws CosmosException;

    public static native void nativeDatabaseFree(long database);

    public static native long nativeContainerClient(long callContext, long database, String containerId)
        throws CosmosException;
    ...
    public static native void nativeCreateItem(long callContext, long container, String partitionKey, String jsonData)
        throws CosmosException;

    public static native String nativeReadItem(long callContext, long container, String partitionKey, String itemId)
        throws CosmosException;

    public static native void nativeUpsertItem(long callContext, long container, String partitionKey, String jsonData)
        throws CosmosException;

    public static native void nativeDeleteItem(long callContext, long container, String partitionKey, String itemId)
        throws CosmosException;
}
