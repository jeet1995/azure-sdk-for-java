 ...
 * {@code Configs.isThinClientEnabled()} null (neither hard-enabled nor hard-disabled),
 * so {@code ThinClientConnectivityConfig.canThinClientBeImplicitlyEnabled()} is true and the
